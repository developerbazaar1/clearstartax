...
<body class="app sidebar-mini">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                    <div class="float-left">
                                        <a href="fq-form.php" class="back-to-tab-one">
                                ...
                                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 mt-3">
                                    ...
                                    <div class="warning-text mt-3 text-left">
                                        <p>Please fill out the financial questionnaire and upload any documents
                                            required.
                                        </p>
                                        <p>You may pause and continue your financial questionnaire anytime by clicking
                                            "save
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-md-3 col-lg-3 col-sm-12 col-xs-12 text-left">
                                                <div class="form-group">
                                                    <label class="form-head" for="exampletext"> Last Name : </label>
                                            ...
                                            <div class="col-md-3 col-lg-3 col-sm-12 col-xs-12 text-left">
                                                <div class="form-group">
                                                    <label class="form-head" for="exampletext"> First Name : </label>
                                                    <input type="text" class="form-control" id="exampleInputtext"
                                            ...
                                            <div class="col-md-3 col-lg-3 col-sm-12 col-xs-12 text-left">
                                                <div class="form-group">
                                                    <label class="form-head" for="exampletext"> Date Of Birth : </label>
                                            ...
                                            <div class="col-md-3 col-lg-3 col-sm-12 col-xs-12 text-left">
                                                <div class="form-group">
                                                    <label class="form-head" for="exampletext"> SSN : </label>
                                                    <input type="text" class="form-control" id="exampleInputtext"
                                            ...
                                            <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                <div class="form-group">
                                                    <label class="form-head" for="exampletext"> Street Address :
                                                    </label>
                                                    <input type="text" class="form-control" id="exampleInputtext"
                                            ...
                                            <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                <div class="form-group">
                                                    <label class="form-head" for="exampletext"> Address line 2 :
                                                    </label>
                                                    <input type="text" class="form-control" id="exampleInputtext"
                                            ...
                                            <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                <div class="form-group">
                                                    <label class="form-head" for="exampletext"> Rent Or Own eg. share
                                                        rent,
                                            ...
                                            <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                <div class="form-group">
                                                    <label class="form-head" for="exampletext"> Driving License </label>
                                                    <input type="text" class="form-control" id="exampleInputtext"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input class="form-check-input" id="optionsRadios1"
                                                                type="radio" name="maritalStatus" value="Single">Single
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input class="form-check-input" id="optionsRadios2"
                                            ...
                                            <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input class="form-check-input" id="optionsRadio1"
                                                                type="radio" name="marriedStatus"
                                                                value="Married Filing Separately">Married Filing
                                                            Separately
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input class="form-check-input" id="optionsRadio2"
                                                                type="radio" name="marriedStatus"
                                                                value="Married Filing Jointly">Married
                                                            Filing Jointly
                                                        </label>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input class="form-check-input" id="optionsRadioyes"
                                                    ...
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input class="form-check-input" id="optionsRadiono"
                                                                type="radio" name="dependents"
                                            ...
                                            <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 mt-2 mb-2 dependency-tab"
                                                ...
                                                <div class="row dependency-form-control px-2">
                                                    ...
                                                    <div class="col-md-3 col-lg-3 col-sm-12 col-xs-12 text-left">
                                                        <div class="form-group">
                                                            <label class="form-head" for="exampletext"> Date Of Birth
                                                            </label>
                                                            <input type="date" class="form-control"
                                                                id="exampleInputtext" placeholder="Enter your DOB"
                                                                required>
                                                        </div>
                                                    </div>
                                                    <!-- :: input 03 Dob -->
                                                    <div class="col-md-3 col-lg-3 col-sm-12 col-xs-12 text-left">
                                                        <div class="form-group">
                                                            <label class="form-head" for="exampletext"> SSN
                                                            </label>
                                                            <input type="text" class="form-control"
                                                                id="exampleInputtext" placeholder="Enter SSN" required>
                                                        </div>
                                                    </div>
                                                    <!-- :: input 04 Dob -->
                                                    <div class="col-md-3 col-lg-3 col-sm-12 col-xs-12 text-left">
                                                        <div class="form-group">
                                                            <label class="form-head" for="exampletext"> Relationship
                                                            </label>
                                                            <input type="text" class="form-control"
                                                                id="exampleInputtext" placeholder="Enter Relationship"
                                                                required>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                <div class="form-group">
                                                    <label class="form-head" for="exampletext">Cash on Hand
                                                        Amount</label>
                                                    <input type="text" class="form-control" id="exampleInputtext"
                                            ...
                                            <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                <div class="form-group">
                                                    <label class="form-head" for="exampletext">How Many Bank Accounts Do
                                                        You
                                                        Have</label>
                                                    <div class="select-group h-40">
                                                        <select class="form-control" id="count-bank-accounts"
                                                            name="count-bank-accounts">
                                            ...
                                            <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12 text-left">
                                                <div class="form-group">
                                                    <label class="form-head" for="exampletext"> Can you take a loan
                                                        against
                                                        your 401k Account?
                                                    </label>
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input class="form-check-input" id="optionsRadio401"
                                                                type="radio" name="401account" value="">Yes
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input class="form-check-input" id="optionsRadio401"
                                                                type="radio" name="401account" value="">No
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    <label class="form-head" for="exampletext"> Do You Have Any
                                                        ...
                                                        <small>(Ex: stocks, bonds, mutual funds, IRA, 401 and all other
                                                            investments/retirement accounts)</small>
                                                    </label>
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input class="form-check-input" id="have-investment-yes"
                                                                type="radio" name="investment" value="Yes">Yes
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input class="form-check-input" id="have-investment-no"
                                                                type="radio" name="investment" value="No">No
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 text-left"
                                                ...
                                                <div class="form-group">
                                                    <label class="form-head" for="exampletext">How many type of
                                                        investments
                                                        do you have?
                                                    </label>
                                                    <div class="select-group h-40">
                                                        <select class="form-control" id="count-investment"
                                                            name="count-investment">
                                                            <option value="0">Select an option</option>
                                                            <option value="1">01</option>
                                                            <option value="2">02</option>
                                                            <option value="3">03</option>
                                            ...
                                            <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 mt-2 mb-2 dependency-tab"
                                                ...
                                                <div class="row count-investment-form-control px-2">
                                                    <!-- :: input 01 Type Of Investment -->
                                                    <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12 text-left">
                                                        <div class="form-group">
                                                            <label class="form-head" for="exampletext"> Type Of
                                                                Investment
                                                            </label>
                                                            <input type="text" class="form-control"
                                                                id="exampleInputtext"
                                                    ...
                                                    <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12 text-left">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                id="exampleInputtext" placeholder="Enter Company Name"
                                                                required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12 text-left">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                id="exampleInputtext" placeholder="Enter Current Value"
                                                                required>
                                                        </div>
                                                    </div>
                                                    <!-- :: input 04 Balance -->
                                                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                id="exampleInputtext" placeholder="Enter Balance"
                                                                required>
                                                        </div>
                                                    </div>
                                                    <!-- :: input 05 Payment -->
                                                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                id="exampleInputtext" placeholder="Enter Payment"
                                                                required>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input class="form-check-input" id="credit-card-yes"
                                                                type="radio" name="credit-cc" value="Yes">Yes
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input class="form-check-input" id="credit-card-no"
                                                                type="radio" name="credit-cc" value="No">No
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left"
                                                ...
                                                <div class="form-group">
                                                    <label class="form-head" for="exampletext">How many Credit Cards Do
                                                        You
                                                        Have?
                                                    </label>
                                                    <div class="select-group h-40">
                                                        <select class="form-control" id="count-credit-accounts"
                                                            name="count-credit-accounts">
                                                            <option value="0">Select an option</option>
                                                            <option value="1">01</option>
                                                            <option value="2">02</option>
                                                            <option value="3">03</option>
                                            ...
                                            <!-- input Do You Have Life Insurance? -->
                                            <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                <div class="form-group">
                                                    <label class="form-head" for="exampletext"> Do You Have Life
                                                        Insurance?
                                                        (Life insurance policy with cash value - NOT TERM LIFE)
                                                    </label>
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input class="form-check-input" id="life-insurance-yes"
                                                                type="radio" name="insurance-d" value="Yes">Yes
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input class="form-check-input" id="life-insurance-no"
                                                                type="radio" name="insurance-d" value="No">No
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="select-group h-40">
                                                        <select class="form-control" id="count-insurance-accounts"
                                                            name="count-insurance-accounts">
                                                            <option value="0">Select an option</option>
                                                            <option value="1">01</option>
                                                            <option value="2">02</option>
                                                        </select>
                                            ...
                                            <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 mt-2 mb-3 dependency-tab"
                                                ...
                                                <div class="form-section-divident text-left mb-2">
                                                    <h6>Life Insurance Policy 1 </h6>
                                                </div>
                                                <!-- form dependecy  -->
                                                <div class="row dependency-form-control px-2">
                                                    <!-- :: input 01 Policy Number-->
                                                    <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12 text-left">
                                                        <div class="form-group">
                                                            <label class="form-head" for="exampletext"> Policy Number
                                                            </label>
                                                            <input type="number" class="form-control"
                                                                id="exampleInputtext" placeholder="Enter Policy Number"
                                                                required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12 text-left">
                                                        <div class="form-group">
                                                            <label class="form-head" for="exampletext"> Current Cash
                                                                Value
                                                            </label>
                                                            <input type="text" class="form-control"
                                                                id="exampleInputtext"
                                            ...
                                            <!-- :: input do you have any real state  -->
                                            <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                <div class="form-group">
                                                    <label class="form-head" for="exampletext"> Do You Own Any Real
                                                        Estate?
                                                        (Any Real Estate/Primary Residence/Rental Properties/ Lands
                                                        Owned)
                                                    </label>
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input class="form-check-input" id="real-estate-yes"
                                                                type="radio" name="r-estate" value="Yes">Yes
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input class="form-check-input" id="real-estate-no"
                                                                type="radio" name="r-estate" value="No">No
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left"
                                                ...
                                                <div class="form-group">
                                                    <label class="form-head" for="exampletext">How Many Properties Do
                                                        You
                                                        Own? *
                                                    </label>
                                                    <div class="select-group h-40">
                                                        <select class="form-control" id="count-real-estate"
                                                            name="count-real-estate">
                                                            <option value="0">Select an option</option>
                                                            <option value="1">01</option>
                                                            <option value="2">02</option>
                                                        </select>
                                            ...
                                            <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 mt-2 mb-3 dependency-tab"
                                                ...
                                                <!-- form dependecy  -->
                                                <div class="row dependency-form-control px-2">
                                                    <!-- :: input 01 Property Address-->
                                                    <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12 text-left">
                                                        <div class="form-group">
                                                            <label class="form-head" for="exampletext"> Property Address
                                                            </label>
                                                            <input type="text" class="form-control"
                                                                id="exampleInputtext" placeholder=" Property Address"
                                                                required>
                                                        </div>
                                                    </div>
                                                    <!-- :: input 02 Country -->
                                                    <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12 text-left">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                id="exampleInputtext" placeholder="Country" required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12 text-left">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                id="exampleInputtext" placeholder="Mortgage Lender"
                                                                required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12 text-left">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                id="exampleInputtext" placeholder="Purchase Date"
                                                                required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12 text-left">
                                                        <div class="form-group">
                                                            <label class="form-head" for="exampletext"> Fair Market
                                                                Value
                                                            </label>
                                                            <input type="text" class="form-control"
                                                                id="exampleInputtext" placeholder=" Fair Market Value"
                                                                required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12 text-left">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                id="exampleInputtext" placeholder="Loan Balance"
                                                                required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12 text-left">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                id="exampleInputtext" placeholder="Monthly Payment"
                                                                required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12 text-left">
                                                        <div class="form-group">
                                                            <label class="form-head" for="exampletext"> Monthly Property
                                                                Tax
                                                            </label>
                                                            <input type="text" class="form-control"
                                                                id="exampleInputtext" placeholder=" Loan Balance"
                                                    ...
                                                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                        <div class="form-group">
                                                            <label class="form-head" for="exampletext"> How is Title
                                                                held
                                                                (Joint, Tenancy, etc.)
                                                            </label>
                                                            <input type="text" class="form-control"
                                                                id="exampleInputtext" placeholder="How is Title held"
                                                                required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                        <div class="form-group">
                                                            <label class="form-head" for="exampletext"> Property 1
                                                                <small>
                                                                    (Upload most recent mortgage statement)</small>
                                                            </label>
                                                            <input type="file" class="form-control"
                                                                id="property-document" name="policy-document"
                                                                accept="image/*">
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <!-- ::::::::::::::::::::::how many property count::::::::::::::::::::::: -->
                                            <!-- input Do You Own A Motor Vehicle? -->
                                            <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                <div class="form-group">
                                                    <label class="form-head" for="exampletext"> Do You Own A Motor
                                                        Vehicle?
                                                    </label>
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input class="form-check-input" id="motor-vehicle-yes"
                                                                type="radio" name="m-vehicle" value="Yes">Yes
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input class="form-check-input" id="motor-vehicle-no"
                                                                type="radio" name="m-vehicle" value="No">No
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left"
                                                ...
                                                <div class="form-group">
                                                    <label class="form-head" for="exampletext">How Many Motor Vehicles
                                                        Do
                                                        You Own?

                                                    </label>
                                                    <div class="select-group h-40">
                                                        <select class="form-control" id="count-motor-vehicle"
                                                            name="count-motor-vehicle">
                                                            <option value="0">Select an option</option>
                                                            <option value="1">01</option>
                                                            <option value="2">02</option>
                                                        </select>
                                            ...
                                            <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 mt-2 mb-2 dependency-tab"
                                                ...
                                                <!-- form investment  -->
                                                <div class="row count-investment-form-control px-2">
                                                    <!-- :: input 01 Make and Model -->
                                                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                        <div class="form-group">
                                                            <label class="form-head" for="exampletext"> Make and Model
                                                            </label>
                                                            <input type="text" class="form-control"
                                                                id="exampleInputtext" placeholder="Enter Make and Model"
                                                                required>
                                                        </div>
                                                    </div>
                                                    <!-- :: input 02 Year -->
                                                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                id="exampleInputtext" placeholder="Enter Year" required>
                                                        </div>
                                                    </div>
                                                    <!-- :: input 03 Mileage -->
                                                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                id="exampleInputtext" placeholder="Enter Mileage"
                                                                required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                id="exampleInputtext" placeholder="Enter Lease or Own"
                                                                required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                id="exampleInputtext" placeholder=" Current Value"
                                                                required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                        <div class="form-group">
                                                            <label class="form-head" for="exampletext"> Current Loan
                                                                Value
                                                            </label>
                                                            <input type="text" class="form-control"
                                                                id="exampleInputtext" placeholder="Current Loan Value"
                                                                required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                        <div class="form-group">
                                                            <label class="form-head" for="exampletext">Name of
                                                                Lender/Lessor
                                                            </label>
                                                            <input type="text" class="form-control"
                                                                id="exampleInputtext"
                                            ...
                                            <!-- :::::::::::::::::: motor vehicle detail form:::::::::::::::: -->
                                            <!-- input Is Vehicle 1 Financed or Leased?   -->
                                            <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input class="form-check-input" id="finance-vehicle-yes"
                                                                type="radio" name="fin-vehicle" value="Yes">Yes
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input class="form-check-input" id="finance-vehicle-no"
                                                                type="radio" name="fin-vehicle" value="No">No
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- :: input upload Vehicle -->
                                            <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" class="form-control" id="vehicleup1"
                                                        name="vehicleup1" accept="image/*">
                                                </div>
                                            </div>
                                            <!-- :: input personal assets -->
                                            <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input class="form-check-input" id="Personal-assets-yes"
                                                                type="radio" name="p-assets" value="Yes">Yes
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input class="form-check-input" id="Personal-assets-no"
                                                                type="radio" name="p-assets" value="No">No
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="select-group h-40">
                                                        <select class="form-control" id="count-personal-assets"
                                                            name="count-personal-assets">
                                                            <option value="0">Select an option</option>
                                                            <option value="1">01</option>
                                                            <option value="2">02</option>
                                            ...
                                            <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 mt-2 mb-3 dependency-tab"
                                                id="dependentSections" style="">
                                                <div class="form-section-divident text-left mb-2">
                                                    <h6>Personal Asset 1 </h6>
                                                </div>
                                                <!-- form dependecy  -->
                                                <div class="row dependency-form-control px-2">
                                                    <!-- :: input 01 Description of Asset-->
                                                    <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12 text-left">
                                                        <div class="form-group">
                                                            <label class="form-head" for="exampletext"> Description of
                                                                Asset
                                                            </label>
                                                            <input type="text" class="form-control"
                                                                id="exampleInputtext" placeholder="Description Of Asset"
                                                                required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <!-- :: input 05 Name of Lender/ Lessor-->
                                                    <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12 text-left">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                id="exampleInputtext"
                                                                placeholder="Name of Lender/ Lessor">
                                                        </div>
                                                    </div>
                                                    <!-- :: input 06 Date of Final Payment -->
                                                    <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12 text-left">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                id="exampleInputtext"
                                                                placeholder="Date of Final Payment">
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                <div class="form-group">
                                                    <label class="form-head"
                                                        for="exampletext">Interest/Dividends</label>
                                                    <input type="text" class="form-control" id="exampleInputtext"
                                            ...
                                            <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                <div class="form-group">
                                                    <label class="form-head" for="exampletext">Net
                                            ...
                                            <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                <div class="form-group">
                                                    <label class="form-head" for="exampletext">Food, Clothing &
                                                        Misc</label>
                                                    <input type="text" class="form-control" id="exampleInputtext"
                                                        placeholder="$0.00" required>
                                                </div>
                                            ...
                                            <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                <div class="form-group">
                                                    <label class="form-head" for="exampletext">Taxes (Income &
                                                        FICA)</label>
                                                    <input type="text" class="form-control" id="exampleInputtext"
                                                        placeholder="$0.00" required>
                                                </div>
                                            ...
                                            <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                <div class="form-group">
                                                    <label class="form-head" for="exampletext">Other Secure
                                                        Debts</label>
                                                    <input type="text" class="form-control" id="exampleInputtext"
                                                        placeholder="$0.00" required>
                                                </div>
                                            ...
                                            <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 text-left">
                                                <div class="form-group">
                                                    <label class="form-head" for="exampletext"> Are you the beneficiary
                                                        of a
                                                        trust, estate, or life insurance policy?

                                                    </label>
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input class="form-check-input" id="beneficiary-yes"
                                                                type="radio" name="t-beneficiary" value="Yes">Yes
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input class="form-check-input" id="beneficiary-no"
                                                                type="radio" name="t-beneficiary" value="No">No
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input class="form-check-input" id="bankruptcy-yes"
                                                                type="radio" name="t-bankruptcy" value="Yes">Yes
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input class="form-check-input" id="bankruptcy-no"
                                                                type="radio" name="t-bankruptcy" value="No">No
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input class="form-check-input" id="lawsuit-yes"
                                                                type="radio" name="p-lawsuit" value="Yes">Yes
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input class="form-check-input" id="lawsuit-no" type="radio"
                                                                name="p-lawsuit" value="No">No
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left"
                                                id="lawsuit-select">
                                                <div class="form-group">
                                                    <label class="form-head" for="exampletext">Date the lawsuit was
                                                        resolved
                                                    </label>
                                                    <input type="text" class="form-control" id="exampleInputtext"
                                            ...
                                            <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                <div class="form-group">
                                                    <label class="form-head" for="exampletext">In the past 10 years,
                                                        have
                                                        you transferred any assets for less than their full value?
                                                    </label>
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input class="form-check-input" id="transferred-assets-yes"
                                                                type="radio" name="tf-assets" value="Yes">Yes
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input class="form-check-input" id="transferred-assets-no"
                                                                type="radio" name="tf-assets" value="No">No
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                <div class="form-group">
                                                    <label class="form-head" for="exampletext">In the past 3 year, have
                                                        you
                                                        transferred any real property (land, house, etc.)?
                                                    </label>
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input class="form-check-input"
                                                                id="transferral-property-yes" type="radio"
                                                                name="transferral-p" value="Yes">Yes
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input class="form-check-input" id="transferral-property-no"
                                                                type="radio" name="transferral-p" value="No">No
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left"
                                                id="transferral-select">
                                                <div class="form-group">
                                                    <label class="form-head" for="exampletext">List the type of property
                                                        and
    ...
    $(document).ready(function() {
        ...
        $('#count-bank-accounts').change(function() {
    ...
    <!-- manage how many motor vehicle show  -->
    <script>
    // Get references to the radio buttons and the select element
    ...
    <!-- vehicle finanace statement upload-->
    <script>
    // Get references to the radio buttons and the select element
    const financevehicleYes = document.getElementById("finance-vehicle-yes");
    const financevehicleNo = document.getElementById("finance-vehicle-no");
    const upfinvehicleSelect = document.getElementById("upfin-vehicle-select");

    // Add event listeners to the radio buttons
    financevehicleYes.addEventListener("change", function() {
        if (this.checked) {
            upfinvehicleSelect.style.display = "block";
        }
    });

    financevehicleNo.addEventListener("change", function() {
        if (this.checked) {
            upfinvehicleSelect.style.display = "none";
        }
    });
    ...
    <!-- personal assets select incomplete  -->
    <!-- bankcruptcy Discharge/Dismissal Date  -->
    <script>
    // Get references to the radio buttons and the select element
