...
<body class="app sidebar-mini">
    ...
    <main class="app-content">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="alert alert-warning alert-dismissible fade show" role="alert"> Complete online Financial
                    Questionnaire form to continue your application process. <a href="fq-form.php"
                        class="link-text">Click here</a>
                    <a type="button" class="close link-text" data-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 25 25"
                                fill="none">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="alert alert-warning alert-dismissible fade show" role="alert"> Complete online TAX ORGANIZER
                    form to continue your application process. <a href="to-form.php" class="link-text">Click here</a>
                    <a type="button" class="close link-text" data-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 25 25"
                                fill="none">
                        ...
                        <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 p-10-20">
                            <div class="tile-body case-inner-card-first">
                                ...
                                <div class="case-card-text d-lg-none">
                                    <h5>What happens next? <span class="mx-1 mb-float-right">
                                            <a href="" class="li-text">Details Shown Here</a>
                                        </span>
                                    </h5>
                                </div>
                        ...
                        <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 p-10-20">
                            <div class="tile-body case-inner-card-first ">
                                <div class="case-card-text d-none-sm">
                                    <h5>What happens next? <span class="mx-1">
                                            <a href="" class="li-text">Details Shown Here</a>
                                        </span>
                                    </h5>
                                </div>
                            ...
                            <div class="document-card">
                                <div class="document-card-items">
                                    <div class="card-icon">
                                        ...
                                        <svg class="d-card-icon d-md-none d-lg-none" xmlns="http://www.w3.org/2000/svg"
                                            width="38" height="38" viewBox="0 0 24 24">
                                            <path fill="#007899" fill-rule="evenodd"
                                ...
                                <div class="document-card-items">
                                    <div class="card-icon">
                                        ...
                                        <svg class="d-card-icon d-md-none d-lg-none" xmlns="http://www.w3.org/2000/svg"
                                            width="38" height="38" viewBox="0 0 24 24">
                                            <g fill="none">
                                                <path stroke="#007899" stroke-linecap="round" stroke-width="1.5"
                                    ...
                                    <div class="card-icon">
                                        ...
                                        <svg class="d-card-icon d-md-none d-lg-none" xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            <g fill="none">
                                                ...
                                                <path stroke="#007899" stroke-linecap="round" stroke-linejoin="round"
                                                    stroke-width="2" d="M8 11h.009m3.982 0H12m3.991 0H16" />
                                            </g>
                                        </svg>
                                    </div>
                                    <div class="db-card-text">
