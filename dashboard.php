                    ...
                    <div class="tile">
                        <div class="tile-body">
                            <div class="document-card">
                                <div class="document-card-items">
                                    <div class="card-icon">
                                        <iconify-icon class="d-card-icon d-none-sm" icon="solar:banknote-2-broken"
                                            style="color: #007899;" width="38" height="38"></iconify-icon>
                                            <svg class="d-card-icon d-md-none d-lg-none" xmlns="http://www.w3.org/2000/svg" width="38" height="38" viewBox="0 0 24 24"><g fill="none" stroke="#007899" stroke-width="1.5"><path stroke-linecap="round" d="M13 5c2.828 0 4.243 0 5.121.879C19 6.757 19 8.172 19 11c0 2.828 0 4.243-.879 5.121C17.243 17 15.828 17 13 17H8c-2.828 0-4.243 0-5.121-.879C2 15.243 2 13.828 2 11c0-2.828 0-4.243.879-5.121C3.757 5 5.172 5 8 5h1m7 15h-5c-2.828 0-4.242 0-5.121-.879c-.49-.49-.707-1.146-.803-2.121m16.046 2.121c.878-.878.878-2.293.878-5.12c0-2.83 0-4.244-.878-5.122c-.49-.49-1.147-.707-2.122-.803"/><path d="M13 11a2.5 2.5 0 1 1-5 0a2.5 2.5 0 0 1 5 0Z"/><path stroke-linecap="round" d="M16 13V9M5 13V9"/></g></svg>
                                    </div>
                                    <div class="db-card-text">
                                        <h5>Payment Hub</h5>
                    ...
                    <div class="tile">
                        <div class="tile-body">
                            <div class="document-card">
                                <div class="document-card-items">
                                    <div class="card-icon">
                                        <iconify-icon class="d-card-icon d-none-sm" icon="solar:calendar-broken"
                                            style="color: #007899;" width="37" height="37"></iconify-icon>
                                            <svg class="d-card-icon d-md-none d-lg-none" xmlns="http://www.w3.org/2000/svg" width="38" height="38" viewBox="0 0 24 24"><g fill="none"><path stroke="#007899" stroke-linecap="round" stroke-width="1.5" d="M14 22h-4c-3.771 0-5.657 0-6.828-1.172C2 19.657 2 17.771 2 14v-2c0-3.771 0-5.657 1.172-6.828C4.343 4 6.229 4 10 4h4c3.771 0 5.657 0 6.828 1.172C22 6.343 22 8.229 22 12v2c0 3.771 0 5.657-1.172 6.828c-.653.654-1.528.943-2.828 1.07M7 4V2.5M17 4V2.5M21.5 9H10.75M2 9h3.875"/><path fill="#007899" d="M18 17a1 1 0 1 1-2 0a1 1 0 0 1 2 0Zm0-4a1 1 0 1 1-2 0a1 1 0 0 1 2 0Zm-5 4a1 1 0 1 1-2 0a1 1 0 0 1 2 0Zm0-4a1 1 0 1 1-2 0a1 1 0 0 1 2 0Zm-5 4a1 1 0 1 1-2 0a1 1 0 0 1 2 0Zm0-4a1 1 0 1 1-2 0a1 1 0 0 1 2 0Z"/></g></svg>
                                    </div>
                                    <div class="db-card-text">
