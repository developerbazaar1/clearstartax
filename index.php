sssssssssssssssssssss<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body class="log-bg">
                            ...
                            <form class=" login-signup-form ">
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <div class="inputWithIcon">
                                        ...
                                        <svg class="i" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                ...
                                <div class="tab-switch-content text-center">
                                    <p>Don’t have an account? <a href="#" class="tab-swich-link text-link-blue"> Sign Up
                                            Now</a></p>
                                </div>
                                <!-- login info -->
                                ...
                                <div class="flex-container justify-content-center mb-3">
                                    <div><svg class="mx-2" xmlns="http://www.w3.org/2000/svg" width="15" height="15"
                                            ...
                                            <path
                                                ...
                                                fill="#333333" />
                                        </svg><a href="#" class="tel">888-235-0004</a>
                                    </div>
                                    <div><svg clas="mx-2" xmlns="http://www.w3.org/2000/svg" width="15" height="15"
                                            viewBox="0 0 15 15" fill="none">
                                            ...
                                            <path d="M3.71431 4.57162L8.00002 7.14305L12.2857 4.57162" stroke="#333333"
                                                stroke-linecap="round" stroke-linejoin="round" />
                                        </svg> <a href="#" class="tel">info@clearstarttax.com</a>
                                    </div>
                                </div>
 ...
 <script>
    const signUpLink = document.querySelector(".tab-swich-link");
    const signUpTabContent = document.querySelector(".signup-form");
