								...
								<form class=" login-signup-form" autocomplete="off" onsubmit="#">
									...
									<div class="form-group mb-2">
										...
										<div class="inputWithIcon">
											...
											<svg class="i" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
									...
									<div class="flex-container justify-content-center mb-3">
										<div>
											<svg class="mx-2 mt-1px" xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 15 15" fill="none">
