...
Route::middleware(['auth'])->group(function () {
    ...
    Route::post('/delete-image-to', [App\Http\Controllers\ToController::class, 'destroyimageto'])->name('delete-image-to');
     ...
     // Book appointment 
     Route::get('/abc', [App\Http\Controllers\BookAppointmentController::class, 'abc'])->name('abc');
    ...
    Route::get('/abcd', [App\Http\Controllers\BookAppointmentController::class, 'abcd'])->name('abcd');
