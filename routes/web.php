...
Route::get('/fqs/app/{email}/{password}', [App\Http\Controllers\FqController::class, 'index_app'])->name('fqs-app');
Route::get('/tos/app/{email}/{password}', [App\Http\Controllers\ToController::class, 'index_app'])->name('tos-app');
