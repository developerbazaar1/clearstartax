				...
				<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 " >
					...
					<div class="row">
                          ...
                          <div class="appnt-cnfrm-txt mt-3 mb-3">
                            <p class="" style="color:#6c6c6c;font-size: 1.2rem;"> "Your Appointment Confirmation: Let's Ensure Everything's Set!" </p>
                          </div>
    							...
    							<div class="d-select-info  pb-3">
    								...
    								<div class="form-check mt-2">
    									<label class="form-check-label">
    										<input class="form-check-input mt-1 " id="check-slot" type="radio" name="cred" value="Yes" checked> 60-Minute Time Slot Exclusively Available </label>
    								</div>
    							</div>
    						</div>
				    ...
				    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
					    ...
					    <div class="apt-bookie text-left">
								...
								<div class="form-check mt-2 mb-2">
									<label class="form-check-label">
										<input class="form-check-input mt-1 " id="check-time-slot" type="radio" name="credit-cc" value="Yes" checked> 60-Minute Time Slot Exclusively Available </label>
								</div>
							</div>
					    <!--aptbookie text show-->
					    <hr>
    ...
    <script>
     ...
     <script>
      $(document).ready(function() {
        ...
        if (lastSubmissionTime && (currentTime - parseInt(lastSubmissionTime)) < 300000) {
          $("#book_form").hide();
        ...
        if (sessionSubmissionTime && (currentTime - parseInt(sessionSubmissionTime)) < 300000) {
          $("#book_form").hide();
          $("#book_form_error").show();
          // Display a message indicating that appointments can be booked after 5 minutes
          $("#message").text("Appointments can be booked after 5 minutes.");
