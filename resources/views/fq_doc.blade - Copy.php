        ...
        <div class="content">
            ...
            <table>
                <tbody>
                    ...
                    <td class="value">
                        <a href="@php echo URL::to('/').'/public/'.$bank['bank']; @endphp"
                            style="display: block; margin-bottom: 10px;">@php echo URL::to('/').'/public/'.$bank['bank']; @endphp</a>
                    </td>
                    ...
                    <td class="value">
                        <a href="@php echo URL::to('/').'/public/'.$cc['Creditcards']; @endphp"
                            style="display: block; margin-bottom: 10px;">@php echo URL::to('/').'/public/'.$cc['Creditcards']; @endphp</a>
                    </td>
                    ...
                    <tr>
                        ...
                        <td class="value">{{$life['policy_document']}}</td>
                    </tr>
                    @php
                       $sno++;
                    @endphp
                    ...
                    <td class="value">
                        <a href="@php echo URL::to('/').'/public/'.$bankspouse['bankspouse']; @endphp"
                            style="display: block; margin-bottom: 10px;">@php echo URL::to('/').'/public/'.$bankspouse['bankspouse']; @endphp</a>
                    </td>
