                            ...
                            <div class="col-md-12 login-form">
                                ...
                                <form action="{{ route('login') }}" class="login-signup-form" autocomplete="off" method="POST">
                                    ...
                                    <div class="form-group mb-2">
                                        <label class="form-head log-form-label" for="mailer-mail">Email ID</label>
                                ...
                                <div class="forget-pass-link text-center mb-3">
                                    <a  href="{{ route('password.request') }}" class="forget-p">Forgot Your Password?</a>
                                </div>
                                <!-- :: signup tag with anchor btn -->
                                <div class="1tab-switch-content text-center">
                                    <p>Don’t have an account? <a href="{{ route('register') }}" class="1tab-swich-link text-link-blue" id="1signup-link"> Sign Up Now</a>
                                    </p>
                                </div>
                                <!--:: login info -->
