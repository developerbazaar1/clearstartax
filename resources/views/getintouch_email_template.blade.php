            ...
            <tr>
             ...
             <tr style="margin: 0 20px 12px 20px; display: block;">
                <td style="background: #EDF8FE; justify-content: space-between; align-items: center; padding: 15px 18px;">
                    <span style="max-width: 600px; display: inline-block; text-align: left;     margin-right: 40px; font-weight: 600">Name: {{$name}}</span>
                    <span style="display:inline-block;width: 390px;text-align: right;"></span>
                </td>
             </tr>
             <tr style="margin: 0 20px 12px 20px; display: block;">
                <td style="background: #EDF8FE;  justify-content: space-between; align-items: center; padding: 15px 18px">
                    <span style="max-width: 600px; display: inline-block; text-align: left;     margin-right: 40px; font-weight: 600">Email: {{$email}}</span>
                    <span style="display:inline-block;width: 390px;text-align: right;"></span>
                </td>
             </tr>
             <tr style="margin: 0 20px 12px 20px; display: block;">
                <td style="background: #EDF8FE;  justify-content: space-between; align-items: center; padding: 15px 18px">
                    <span style="max-width: 600px; display: inline-block; text-align: left;     margin-right: 40px; font-weight: 600">Subject: {{$subject1}}</span>
                    <span style="display:inline-block;width: 448px;text-align: right;"></span>
                </td>
             </tr>
             <tr style="margin: 0 20px 50px 20px; display: block;">
                <td style="background: #EDF8FE;  justify-content: space-between; align-items: center; padding: 15px 18px">
                    <span style="max-width: 600px; display: inline-block; text-align: left; margin-right: 40px; font-weight: 600">Message: {{$message1}}</span>
