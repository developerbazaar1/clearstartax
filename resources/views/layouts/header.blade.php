...
<html lang="en">
    <head>
        ...
        <title>Clear Start Tax Relief | Client Portal</title>
    ...
    <body class="app sidebar-mini">
        ...
        <header class="app-header d-lg-none">
            <a class="app-header__logo" href="{{url('/home')}}">
                <img class="dashboard-brand mt-4 mbmt-0" src="{{ URL::asset('assets/img/cleartax-brand-logo.png') }}">
            </a>
        ...
        <aside class="app-sidebar">
            <header class="app-head">
                <a class="app-header__logo" href="{{url('/home')}}">
                    <img class="dashboard-brand mt-4 " src="{{ URL::asset('assets/img/cleartax-brand-logo.png') }}">
                </a>
            </header>
            <!--::  user details -->
            <div class="app-sidebar__user">
                <!--<img class="app-sidebar__user-avatar" src="{{ URL::asset('assets/img/user-img.png') }}" alt="User Image">-->
                <div>
                    <p class="app-sidebar__user-name">
                        <strong>@php echo ucfirst(Auth::user()->name); @endphp</strong>
                    </p>
                    <p class="app-sidebar__user-designation mt-5px">Case ID : <a href="#" class="case-id-data">@php echo Auth::user()->case_id @endphp</a>
                    </p>
                    <p class="app-sidebar__user-designation mt-5px">Status : <a href="{{ route('more-info') }}" class="case-id-data">More Info <svg
            ...
            <ul class="app-menu">
                ...
                <!-- :: menu items 02 -->
                <li>
                    <a class="app-menu__item" href="{{ route('payment') }}">
                        <svg class="app-menu__icon mx-3" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            viewBox="0 0 24 24">
                            <g fill="none" stroke="white" stroke-width="1.5">
                                <path stroke-linecap="round"
                ...
                <!-- :: menu items 03 -->
                <li>
                    <a class="app-menu__item" href="{{ route('documents') }}">
                        
                      <svg class="app-menu__icon mx-3" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><g fill="none" stroke="white" stroke-linecap="round" stroke-width="1.5"><path stroke-linejoin="round" d="M12 17v-7m0 0l3 3m-3-3l-3 3"/><path d="M16 7H8m14 5c0 4.714 0 7.071-1.465 8.535C19.072 22 16.714 22 12 22s-7.071 0-8.536-1.465C2 19.072 2 16.714 2 12s0-7.071 1.464-8.536C4.93 2 7.286 2 12 2c4.714 0 7.071 0 8.535 1.464c.974.974 1.3 2.343 1.41 4.536"/></g></svg>
                        <span class="app-menu__label">Documents</span>
                    </a>
                </li>
                <!-- :: menu items 04 -->
                
                @if (in_array($statusid, $status_for_appointment))
                <li>
                    <a class="app-menu__item required-its" href="{{ route('appointment') }}">
                        <svg class="app-menu__icon mx-3" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            viewBox="0 0 24 24">
                            <g fill="none">
                      ...
                      <iconify-icon class="icon-stts-show" icon="fa:exclamation" width="13" height="13"  style="color: #ea9038"></iconify-icon>
                    </a>
                </li>
                @endif
                
                @if (in_array($statusid, $status_for_fq))
                <li>
                    <a class="app-menu__item required-its" href="{{ route('fqs') }}">
                        <svg class="app-menu__icon mx-3" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            viewBox="0 0 24 24">
                            <g fill="none" stroke="white" stroke-width="1.5">
                                <path
                        ...
                        <span class="app-menu__label">Financial Questio...</span>
                         <iconify-icon class="icon-stts-show" icon="fa:exclamation" width="13" height="13"  style="color: #ea9038"></iconify-icon>
                    </a>
                </li>
                @endif
                 
                 @if (in_array($statusid, $status_for_to)) 
                <li>
                    <a class="app-menu__item required-its" href="{{ route('tos') }}">
                        <svg class="app-menu__icon mx-3" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            viewBox="0 0 24 24">
                            <g fill="none" stroke="white" stroke-width="1.5">
                                <path
                        ...
                        <span class="app-menu__label">Tax Organizer</span>
                         <iconify-icon class="icon-stts-show" icon="fa:exclamation" width="13" height="13"  style="color: #ea9038"></iconify-icon>
                    </a>
                </li>
                @endif
                ...
                <!-- :: menu items 05 -->
                <li>
                    <a class="app-menu__item" href="{{ route('faq') }}">
                        <svg class="app-menu__icon mx-3" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            viewBox="0 0 24 24">
                            <g fill="none">
                                <path stroke="white" stroke-linecap="round" stroke-width="1.5"
                ...
                <li>
                    <a class="app-menu__item" href="{{ route('taxnews') }}">
                        <svg class="app-menu__icon mx-3" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 512 512"><path fill="none" stroke="white" stroke-linejoin="round" stroke-width="32" d="M368 415.86V72a24.07 24.07 0 0 0-24-24H72a24.07 24.07 0 0 0-24 24v352a40.12 40.12 0 0 0 40 40h328"></path><path fill="none" stroke="white" stroke-linejoin="round" stroke-width="32" d="M416 464a48 48 0 0 1-48-48V128h72a24 24 0 0 1 24 24v264a48 48 0 0 1-48 48Z"></path><path fill="none" stroke="white" stroke-linecap="round" stroke-linejoin="round" stroke-width="32" d="M240 128h64m-64 64h64m-192 64h192m-192 64h192m-192 64h192"></path><path fill="white" d="M176 208h-64a16 16 0 0 1-16-16v-64a16 16 0 0 1 16-16h64a16 16 0 0 1 16 16v64a16 16 0 0 1-16 16"></path></svg>
                        <span class="app-menu__label">Tax news</span>
                    </a>
                </li>
            
                <li>
                    <a class="app-menu__item" href="{{ route('contact') }}">
                        <svg class="app-menu__icon mx-3" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            viewBox="0 0 24 24">
                            <g fill="none">
                                <path fill="white"
                ...
                <!-- :: signout btn -->
                <li>
                    <a class="app-menu__item mt-5" href="{{ route('logout') }}"
        ...
        <script type="text/javascript" src="{{ URL::asset('assets/js/cardvalidation.js') }}"></script>
         @yield('scripts')
    </body>
</html>
