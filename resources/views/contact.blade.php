		...
		<div class="tile-x">
			...
			<div class="cnt-form">
				@if($message = Session::get('success'))
                    ...
                    <div class="alert m-3 p-2 alert-success alert-dismissible" role="alert">
                      {{ $message }}
					...
					<div class="row justify-content-center p-4">
						...
						<div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
							<div class="form-group">
								...
								<textarea class="form-control p-10" placeholder="Write message" id="message" name="message" rows="3"></textarea>
							</div>
						</div>
