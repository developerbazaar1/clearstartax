...
>
                                    ...
                                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="Discharge/Dismissal_Date" id="Discharge/Dismissal_Date" value="@if(!empty($fq->Discharge_Dismissal_Date)){{old('Discharge/Dismissal_Date#', $fq->Discharge_Dismissal_Date)}}@endif"
                                    ...
                                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="Date_the_lawsuit_was_resolved" id="Date_the_lawsuit_was_resolved"
                                    ...
                                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control " name="Date_the_asset_was_transferred" id="Date_the_asset_was_transferred"
