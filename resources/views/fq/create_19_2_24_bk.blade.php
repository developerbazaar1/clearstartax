                                                ...
                                                <div class="row dependency-form-control px-2">
                                                    ...
                                                    <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12 text-left">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="spouse_first_name" id="spouse_first_name"  value="{{ old('spouse_first_name') }}"
                                                                placeholder="Enter first name" >
                                                        </div>
                                                    </div>
                                                    <!-- :: input 02 last name -->
                                                    <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12 text-left">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="spouse_last_name" id="spouse_last_name" value="{{ old('spouse_last_name') }}"
                                                    ...
                                                    <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12 text-left">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="spouse_Driver_License" id="spouse_Driver_License" value="{{ old('spouse_Driver_License') }}"
                                                    ...
                                                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="date" class="form-control" name="spouse_date_of_birth" id="spouse_date_of_birth" value="{{ old('spouse_date_of_birth') }}"
                                                                >
                                                        </div>
                                                    </div>
                                                </div>
...
>
                                    ...
                                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="Discharge/Dismissal_Date" id="Discharge/Dismissal_Date"
