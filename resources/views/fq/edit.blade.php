                                   ...
                                   <div class="col-md-3 col-lg-3 col-sm-12 col-xs-12 text-left">
                                    ...
                                    <div class="col-md-3 col-lg-3 col-sm-12 col-xs-12 text-left">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="SSN#" value="@if(!empty($fq->SSN)){{old('SSN#', $fq->SSN)}}@endif"  class="ssn_valid form-control @error('SSN#') is-invalid @enderror " id="SSN#"
                                                ...
                                                <div class="row dependency-form-control px-2">
                                                    ...
                                                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="ssn_valid form-control" name="spouse_ssn" id="spouse_ssn"
                                    ...
                                    <div class="col-12">
                                        <div class="row"> 
                                            ...
                                            @if($fq->Married_Filing_Status == 'Married Filing Jointly' && $fq->Marital_Status == 'Married')
                                                    ...
                                                    @if($fq->spouse_employment_status == 'Self-Employed' )
                                                    <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12 dependency-tab Spouse_Employment_Status_detail_Section1"  id="Spouse_Employment_Status_detail_Section_em">
                                                        ...
                                                        <div class="row px-2">
                                                            ...
                                                            <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12 text-left">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="Em_Employer_Name" id="emspousename" placeholder=""  value="@if(!empty($fq->Em_Employer_Name)){{old('Em_Employer_Name', $fq->Em_Employer_Name)}}@endif" >
                                                                </div>
                                                            </div>
                                                            <!-- :: input 02 -->
                                                            <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12 text-left">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" id="emspouseOccupation" name="Em_Occupation" placeholder=""  value="@if(!empty($fq->Em_Occupation)){{old('Em_Occupation', $fq->Em_Occupation)}}@endif"  >
                                                                </div>
                                                            </div>
                                                            <!-- input 03 -->
                                                            <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12 text-left">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" id="emspouseAddress" name="Em_Employer_Address" placeholder=""  value="@if(!empty($fq->Em_Employer_Address)){{old('Em_Employer_Address', $fq->Em_Employer_Address)}}@endif" >
                                                                </div>
                                                            </div>
                                                            <!-- input 04 -->
                                                            <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="Em_How_Long_with_this_Employer" id="emspousetime" placeholder=""  value="@if(!empty($fq->Em_How_Long_with_this_Employer)){{old('Em_How_Long_with_this_Employer', $fq->Em_How_Long_with_this_Employer)}}@endif" >
                                                                </div>
                                                            </div>
                                                            <!-- input 05 -->
                                                            <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="Em_Number_of_Exemptions_claimed_on_W4" class="form-control" id="emspousew4" placeholder=""  value="@if(!empty($fq->Em_Number_of_Exemptions_claimed_on_W4)){{old('Em_Number_of_Exemptions_claimed_on_W4', $fq->Em_Number_of_Exemptions_claimed_on_W4)}}@endif" >
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!-- radio for spouse pay period -->
                                                    <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 mt-4 Spouse_Employment_Status_detail_Section2"  id="Spouse_Employment_Status_detail_Section_spouse" >
                                                        <div class=" mt-2 mb-2">
                                                            <!-- :::input radio -->
                                                            <div class="form-group d-flex cnt-justified" style="align-items: baseline;">
                                                                ...
                                                                <div class="form-check">
                                                                    <label class="form-check-label">
                                                                        <input class="form-check-input" id="optionsRadiosWeekly" type="radio" name="EmspStatus" value="Weekly" @if($fq->EmspStatus == 'Weekly') checked @endif >Weekly </label>
                                                                </div>
                                                                <div class="form-check">
                                                                    <label class="form-check-label">
                                                                        <input class="form-check-input" id="optionsRadiosmonthly" type="radio" name="EmspStatus" value="Monthly" @if($fq->EmspStatus == 'Monthly') checked @endif >Monthly </label>
                                                                </div>
                                                                <div class="form-check">
                                                                    <label class="form-check-label">
                                                                        <input class="form-check-input" id="optionsRadiosbiweekly" type="radio" name="EmspStatus" value="Bi-Weekly" @if($fq->EmspStatus == 'Bi-Weekly') checked @endif >Bi-Weekly </label>
                                                                </div>
                                                                <div class="form-check">
                                                                    <label class="form-check-label">
                                                                        <input class="form-check-input" id="optionsRadiossemi-monthly " type="radio" name="EmspStatus" value="Semi-Monthly" @if($fq->EmspStatus == 'Semi-Monthly') checked @endif >Semi-Monthly </label>
                                                                </div>
                                                                <div class="form-check">
                                                                    <input type="text" class="form-control" name="emspouseamount" id="emspouseamount" placeholder=""  value="@if(!empty($fq->emspouseamount)){{old('emspouseamount', $fq->emspouseamount)}}@endif" >
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    @elseif($fq->spouse_employment_status == 'Wage Earner' )
                                                    <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12 dependency-tab Spouse_Employment_Status_detail_Section1"  id="Spouse_Employment_Status_detail_Section_em">
                                                        <div class="form-section-divident text-left mb-3">
                                                            <h6>Employer</h6>
                                                        </div>
                                                    ...
                                                    @elseif($fq->spouse_employment_status == 'Disability' )
                                                    <!-- radio for spouse pay period -->
                                                    <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 mt-4 Spouse_Employment_Status_detail_Section2"  id="Spouse_Employment_Status_detail_Section_spouse" >
                                                        <div class=" mt-2 mb-2">
                                                            <!-- :::input radio -->
                                                    ...
                                                    @elseif($fq->spouse_employment_status == 'Retired' )
                                                    ...
                                                    @elseif($fq->spouse_employment_status == 'Unemployed' )
                                                    <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12 dependency-tab Spouse_Employment_Status_detail_Section1"  id="Spouse_Employment_Status_detail_Section_em" style="display: none;">
                                                        <div class="form-section-divident text-left mb-3">
                                                            <h6>Employer</h6>
                                                        </div>
                                    ...
                                    <!-- ::::::section 02::::::: -->
                                    @if($fq->Married_Filing_Status == 'Married Filing Jointly' && $fq->Marital_Status == 'Married')
                                    <div class="col-12" id="spousesection2a">
                                        <div class="row">
                                            ...
                                            @if($fq->spouse_employment_status == 'Self-Employed' )
                                            <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12 dependency-tab Spouse_Employment_Status_detail_Section1"  id="Spouse_Employment_Status_detail_Section_spouse" >
                                                <div class="form-section-divident text-left mb-3">
                                                ...
                                                <div class="row px-2">
                                                    ...
                                                    <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12 text-left">
                                                        <div class="form-group">
                                                            <label class="form-head" for="spouname">Employer Name</label>
                                                            <input type="text" class="form-control" name="Spouse_Employer_Name" id="spousename"  placeholder="" value="@if(!empty($fq->Spouse_Employer_Name)){{old('Spouse_Employer_Name', $fq->Spouse_Employer_Name)}}@endif">
                                                        </div>
                                                    </div>
                                                    <!-- :: input 02 -->
                                                    <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12 text-left">
                                                        <div class="form-group">
                                                            <label class="form-head" for="spOccupation">Occupation</label>
                                                            <input type="text" class="form-control" id="spouseOccupation" name="Spouse_Occupation" placeholder="" value="@if(!empty($fq->Spouse_Occupation)){{old('Spouse_Occupation', $fq->Spouse_Occupation)}}@endif">
                                                        </div>
                                                    </div>
                                                    <!-- input 03 -->
                                                    <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12 text-left">
                                                        <div class="form-group">
                                                            <label class="form-head" for="spaddress">Employer Address</label>
                                                            <input type="text" class="form-control" id="spouseAddress" name="Spouse_Employer_Address" placeholder="" value="@if(!empty($fq->Spouse_Employer_Address)){{old('Spouse_Employer_Address', $fq->Spouse_Employer_Address)}}@endif">
                                                        </div>
                                                    </div>
                                                    <!-- input 04 -->
                                                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                        <div class="form-group">
                                                            <label class="form-head" for="sptime">How Long with this Employer</label>
                                                            <input type="text" class="form-control" name="Spouse_How_Long_with_this_Employer" id="spousetime" placeholder="" value="@if(!empty($fq->Spouse_How_Long_with_this_Employer)){{old('Spouse_How_Long_with_this_Employer', $fq->Spouse_How_Long_with_this_Employer)}}@endif">
                                                        </div>
                                                    </div>
                                                    <!-- input 05 -->
                                                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                        <div class="form-group">
                                                            <label class="form-head" for="spw4">Number of Exemptions claimed on W4</label>
                                                            <input type="text" name="Spouse_Number_of_Exemptions_claimed_on_W4" class="form-control" id="spousew4" placeholder="" value="@if(!empty($fq->Spouse_Number_of_Exemptions_claimed_on_W4)){{old('Spouse_Number_of_Exemptions_claimed_on_W4', $fq->Spouse_Number_of_Exemptions_claimed_on_W4)}}@endif">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 mt-4 Spouse_Employment_Status_detail_Section2"  id="Spouse_Employment_Status_detail_Section_spouse" >
                                                <div class=" mt-2 mb-2">
                                                    ...
                                                    <div class="form-group d-flex cnt-justified" style="align-items: baseline;">
                                                        ...
                                                        <div class="form-check">
                                                            <label class="form-check-label">
                                                                <input class="form-check-input" id="optionsRadiosWeekly" type="radio" name="spStatus" value="Weekly" @if($fq->spStatus == 'Weekly') checked @endif >Weekly </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <label class="form-check-label">
                                                                <input class="form-check-input" id="optionsRadiosmonthly" type="radio" name="spStatus" value="Monthly"  @if($fq->spStatus == 'Monthly') checked @endif >Monthly </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <label class="form-check-label">
                                                                <input class="form-check-input" id="optionsRadiosbiweekly" type="radio" name="spStatus" value="Bi-Weekly"  @if($fq->spStatus == 'Bi-Weekly') checked @endif >Bi-Weekly </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <label class="form-check-label">
                                                                <input class="form-check-input" id="optionsRadiossemi-monthly " type="radio" name="spStatus" value="Semi-Monthly"  @if($fq->spStatus == 'Semi-Monthly') checked @endif >Semi-Monthly </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input type="text" class="form-control" name="Spouse_Pay_amount" id="spouseamount" placeholder="" value="@if(!empty($fq->Spouse_Pay_amount)){{old('Spouse_Pay_amount', $fq->Spouse_Pay_amount)}}@endif">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
>
                                    ...
                                    @if($fq->Married_Filing_Status == 'Married Filing Jointly' && $fq->Marital_Status == 'Married')
                                    <div class="col-12" id="spousesection3a">
                                        <div class="row"  >
                                            <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 mb-4">
                                                <div class="form-section-highlite mt-3">
                                            ...
                                            <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                <div class="form-group">
                                                    ...
                                                    <span class="currency_input">$</span>
                                                    <input type="number"  step="any" class="numberInputOnly1 form-control" name="Spouse_Cash_on_Hand_Amount" id="Spouse_Cash_on_Hand_Amount" value="@if(!empty($fq->Spouse_Cash_on_Hand_Amount)){{old('Spouse_Cash_on_Hand_Amount$i', $fq->Spouse_Cash_on_Hand_Amount)}}@endif"
                                                        placeholder="$" >
                                                </div>
                                            </div>
                                            <!-- :: input How Many Bank Accounts Do You Have -->
                                    ...
                                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                        <div class="form-group">
                                            ...
                                            <span class="currency_input">$</span>
                                            <input type="number"  step="any" class="numberInputOnly1 form-control numberInput @error('Interest/Dividends') is-invalid @enderror" name="Interest/Dividends" id="Interest/Dividends"
                                    ...
                                    @if($fq->Married_Filing_Status == 'Married Filing Jointly' && $fq->Marital_Status == 'Married')
                                            ...
                                            @if($fq->spouse_employment_status == 'Self-Employed' )
                                                <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 dependency-tab mb-2 Spouse_Employment_Status_detail_Section3_under4a" id="Spouse_Employment_Status_detail_Section3_under4a_spouse">
                                                    <div class="warning-text mt-3 text-left">
                                                        <p>
                                                    ...
                                                    <div class="row px-1">
                                                        ...
                                                        <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12 text-left">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="spbusinessName" name="Spouse_Business_Name" placeholder="" value="@if(!empty($fq->Spouse_Business_Name)){{old('Spouse_Business_Name', $fq->Spouse_Business_Name)}}@endif">
                                                            </div>
                                                        </div>
                                                        <!-- input 02 -->
                                                        <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12 text-left">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="espempids" placeholder="" name="Spouse_Employee_ID" value="@if(!empty($fq->Spouse_Employee_ID)){{old('Spouse_Employee_ID', $fq->Spouse_Employee_ID)}}@endif">
                                                            </div>
                                                        </div>
                                                        <!-- input 03 -->
                                                        <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12 text-left">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" class="form-control" id="spempnumber" placeholder="" name="Spouse_No_of_Employees" value="@if(!empty($fq->Spouse_No_of_Employees)){{old('Spouse_No_of_Employees', $fq->Spouse_No_of_Employees)}}@endif">
                                                            </div>
                                                        </div>
                                                        <!-- input 04 -->
                                                        <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" class="form-control" id="avppayroll" placeholder="" name="Spouse_Average_Monthly_Payroll" value="@if(!empty($fq->Spouse_Average_Monthly_Payroll)){{old('Spouse_Average_Monthly_Payroll', $fq->Spouse_Average_Monthly_Payroll)}}@endif">
                                                            </div>
                                                        </div>
                                                        <!-- input 05 -->
                                                        <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="btype" placeholder="" name="Spouse_Type_of_Business" value="@if(!empty($fq->Spouse_Type_of_Business)){{old('Spouse_Type_of_Business', $fq->Spouse_Type_of_Business)}}@endif">
                                                            </div>
                                                        </div>
                                                        <!-- input 06 -->
                                                        <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="freqtd" placeholder="" name="Spouse_Frequency_of_Tax_Deposits" value="@if(!empty($fq->Spouse_Frequency_of_Tax_Deposits)){{old('Spouse_Frequency_of_Tax_Deposits', $fq->Spouse_Frequency_of_Tax_Deposits)}}@endif">
                                                            </div>
                                                        </div>
                                                        <!-- input 07 -->
                                                        <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="bweb" placeholder="" name="Spouse_Business_Website" value="@if(!empty($fq->Spouse_Business_Website)){{old('Spouse_Business_Website', $fq->Spouse_Business_Website)}}@endif">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!-- :: inputs  -->
                                    ...
                                    @if($fq->Client_employment_status == 'Self-Employed')
                                        ...
                                        <div class="row">
                                          ...
                                          <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                            <div class="form-group">
                                              ...
                                              <span class="currency_input">$</span>
                                              <input type="number" step="any" class="@error('Business_Cash_On_Hand') is-invalid @enderror numberInputOnly1 form-control  numberInputOnly1 " name="Business_Cash_On_Hand" id="Business_Cash_On_Hand" placeholder="0.00" value="@if(!empty($fq->Driver_License)){{old('Driver_license#', $fq->Driver_License)}}@endif">
                                          ...
                                          <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                            <div class="form-group">
                                              ...
                                              <input type="hidden" class="form-control" value="@if(!empty($fq->Business_Bank_Account)){{old('Business_Bank_Account', $fq->Business_Bank_Account)}}@endif" id="Business_Bank_Account_old" name="Business_Bank_Account_old" >
                                                    @if(!empty($fq->Business_Bank_Account))
                                                    <a target="_blank"  class="" href="@php echo URL::to('/').'/public/'.$fq->Business_Bank_Account; @endphp" style="font-size: 10px;">@php echo URL::to('/').'/public/'.$fq->Business_Bank_Account; @endphp</a>
                                                    @endif
                                          ...
                                          <div class="col-md-12">
                                            <div class="row">
                                              <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12 text-left">
                                                <div class="form-group">
                                                  ...
                                                  <div class="form-check">
                                                    <label class="form-check-label">
                                                      <input class="form-check-input  @error('Are_you_able_to_provide_current_year_Profit_Loss_Statement') is-invalid @enderror" id="Are_you_able_to_provide_current_year_Profit_Loss_Statement" type="radio" name="Are_you_able_to_provide_current_year_Profit_Loss_Statement" value="yes" @if($fq->Are_you_able_to_provide_current_year_Profit_Loss_Statement == 'yes') checked @endif>Yes </label>
                                                  </div>
                                                  <div class="form-check">
                                                    <label class="form-check-label">
                                                      <input class="form-check-input @error('Are_you_able_to_provide_current_year_Profit_Loss_Statement') is-invalid @enderror" id="Are_you_able_to_provide_current_year_Profit_Loss_Statement1" type="radio" name="Are_you_able_to_provide_current_year_Profit_Loss_Statement" value="no" @if($fq->Are_you_able_to_provide_current_year_Profit_Loss_Statement == 'no') checked @endif >No 
                                              ...
                                              @if($fq->Are_you_able_to_provide_current_year_Profit_Loss_Statement == 'yes')
                                              <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left" id="section5b_yes" style="display: block;">
                                                <div class="form-group">
                                                  ...
                                                  <input type="hidden" class="form-control" value="@if(!empty($fq->Upload_Most_Recent_Profit_Loss_Statement)){{old('Upload_Most_Recent_Profit_Loss_Statement$i', $fq->Upload_Most_Recent_Profit_Loss_Statement)}}@endif" id="Upload_Most_Recent_Profit_Loss_Statement_old" name="Upload_Most_Recent_Profit_Loss_Statement_old" >
                                                    @if(!empty($fq->Upload_Most_Recent_Profit_Loss_Statement))
                                                    <a target="_blank"  class="" href="@php echo URL::to('/').'/public/'.$fq->Upload_Most_Recent_Profit_Loss_Statement; @endphp" style="font-size: 10px;">@php echo URL::to('/').'/public/'.$fq->Upload_Most_Recent_Profit_Loss_Statement; @endphp</a>
                                                    @endif
                                            ...
                                            @if($fq->Are_you_able_to_provide_current_year_Profit_Loss_Statement == 'no')
                                              ...
                                              <div class="row">
                                                ...
                                                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                  <div class="form-group">
                                                    ...
                                                    <span class="currency_input">$</span>
                                                    <input type="number" step="any" class="numberInputOnly1 form-control  numberInputOnly1 @error('Item_Actual_Monthly_Gross_Receipts') is-invalid @enderror " name="Item_Actual_Monthly_Gross_Receipts" id="Item_Actual_Monthly_Gross_Receipts" placeholder="0.00" value="@if(!empty($fq->Item_Actual_Monthly_Gross_Receipts)){{old('Item_Actual_Monthly_Gross_Receipts', $fq->Item_Actual_Monthly_Gross_Receipts)}}@endif">
                                                ...
                                                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                  <div class="form-group">
                                                    ...
                                                    <span class="currency_input">$</span>
                                                    <input type="number" step="any" class="numberInputOnly1 form-control  numberInputOnly1 @error('Gross_Rental_Income') is-invalid @enderror " name="Gross_Rental_Income" id="Gross_Rental_Income" placeholder="0.00" value="@if(!empty($fq->Gross_Rental_Income)){{old('Gross_Rental_Income', $fq->Gross_Rental_Income)}}@endif">
                                                ...
                                                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                  <div class="form-group">
                                                    ...
                                                    <span class="currency_input">$</span>
                                                    <input type="number" step="any" class="numberInputOnly1 form-control  numberInputOnly1 @error('Interest') is-invalid @enderror " name="Interest" id="Interest" placeholder="0.00" value="@if(!empty($fq->Interest)){{old('Interest', $fq->Interest)}}@endif">
                                                    @error('Interest')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                                ...
                                                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                  <div class="form-group">
                                                    ...
                                                    <span class="currency_input">$</span>
                                                    <input type="number" step="any" class="numberInputOnly1 form-control  numberInputOnly1 @error('Dividends') is-invalid @enderror " name="Dividends" id="Dividends" placeholder="0.00" value="@if(!empty($fq->Dividends)){{old('Dividends', $fq->Dividends)}}@endif">
                                                    @error('Dividends')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                                ...
                                                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                  <div class="form-group">
                                                    ...
                                                    <span class="currency_input">$</span>
                                                    <input type="number" step="any" class="numberInputOnly1 form-control  numberInputOnly1 @error('Cash') is-invalid @enderror " name="Cash" id="Cash" placeholder="0.00" value="@if(!empty($fq->Cash)){{old('Cash', $fq->Cash)}}@endif">
                                                    @error('Cash')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                                ...
                                                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                  <div class="form-group">
                                                    ...
                                                    <span class="currency_input">$</span>
                                                    <input type="number" step="any" class="numberInputOnly1 form-control  numberInputOnly1 @error('Other_Income_5b') is-invalid @enderror " name="Other_Income_5b" id="Other_Income_5b" placeholder="0.00" value="@if(!empty($fq->Other_Income_5b)){{old('Other_Income_5b', $fq->Other_Income_5b)}}@endif">
                                                ...
                                                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                  <div class="form-group">
                                                    ...
                                                    <span class="currency_input">$</span>
                                                    <input type="number" step="any" class="numberInputOnly1 form-control  numberInputOnly1 @error('Total_Business_Income') is-invalid @enderror " name="Total_Business_Income" id="Total_Business_Income" placeholder="0.00" value="@if(!empty($fq->Total_Business_Income)){{old('Total_Business_Income', $fq->Total_Business_Income)}}@endif">
                                                ...
                                                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                  <div class="form-group">
                                                    ...
                                                    <span class="currency_input">$</span>
                                                    <input type="number" step="any" class="numberInputOnly1 form-control  numberInputOnly1 @error('Materials_Purchased') is-invalid @enderror " name="Materials_Purchased" id="Materials_Purchased" placeholder="0.00" value="@if(!empty($fq->Materials_Purchased)){{old('Materials_Purchased', $fq->Materials_Purchased)}}@endif">
                                                ...
                                                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                  <div class="form-group">
                                                    ...
                                                    <span class="currency_input">$</span>
                                                    <input type="number" step="any" class="numberInputOnly1 form-control  numberInputOnly1 @error('Inventory_Purchased') is-invalid @enderror " name="Inventory_Purchased" id="Inventory_Purchased" placeholder="0.00" value="@if(!empty($fq->Inventory_Purchased)){{old('Inventory_Purchased', $fq->Inventory_Purchased)}}@endif">
                                                ...
                                                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                  <div class="form-group">
                                                    ...
                                                    <span class="currency_input">$</span>
                                                    <input type="number" step="any" class="numberInputOnly1 form-control  numberInputOnly1 @error('Gross_Wages_Salaries') is-invalid @enderror " name="Gross_Wages_Salaries" id="Gross_Wages_Salaries" placeholder="0.00" value="@if(!empty($fq->Gross_Wages_Salaries)){{old('Gross_Wages_Salaries', $fq->Gross_Wages_Salaries)}}@endif">
                                                ...
                                                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                  <div class="form-group">
                                                    ...
                                                    <span class="currency_input">$</span>
                                                    <input type="number" step="any" class="numberInputOnly1 form-control  numberInputOnly1 @error('Rent') is-invalid @enderror " name="Rent" id="Rent" placeholder="0.00" value="@if(!empty($fq->Rent)){{old('Rent', $fq->Rent)}}@endif">
                                                    @error('Rent')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                                ...
                                                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                  <div class="form-group">
                                                    ...
                                                    <span class="currency_input">$</span>
                                                    <input type="number" step="any" class="numberInputOnly1 form-control  numberInputOnly1 @error('Supplies') is-invalid @enderror " name="Supplies" id="Supplies" placeholder="0.00" value="@if(!empty($fq->Supplies)){{old('Supplies', $fq->Supplies)}}@endif">
                                                    @error('Supplies')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                                ...
                                                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                  <div class="form-group">
                                                    ...
                                                    <span class="currency_input">$</span>
                                                    <input type="number" step="any" class="numberInputOnly1 form-control  numberInputOnly1 @error('Business_Expenses') is-invalid @enderror " name="Business_Expenses" id="Business_Expenses" placeholder="0.00" value="@if(!empty($fq->Business_Expenses)){{old('Business_Expenses', $fq->Business_Expenses)}}@endif">
                                                ...
                                                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                  <div class="form-group">
                                                    ...
                                                    <span class="currency_input">$</span>
                                                    <input type="number" step="any" class="numberInputOnly1 form-control  numberInputOnly1 @error('Utilities_Telephone') is-invalid @enderror " name="Utilities_Telephone" id="Utilities_Telephone" placeholder="0.00" value="@if(!empty($fq->Utilities_Telephone)){{old('Utilities_Telephone', $fq->Utilities_Telephone)}}@endif">
                                                ...
                                                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                  <div class="form-group">
                                                    ...
                                                    <span class="currency_input">$</span>
                                                    <input type="number" step="any" class="numberInputOnly1 form-control  numberInputOnly1 @error('Vehicle_Gas_Oil') is-invalid @enderror " name="Vehicle_Gas_Oil" id="Vehicle_Gas_Oil" placeholder="0.00" value="@if(!empty($fq->Vehicle_Gas_Oil)){{old('Vehicle_Gas_Oil', $fq->Vehicle_Gas_Oil)}}@endif">
                                                ...
                                                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                  <div class="form-group">
                                                    ...
                                                    <span class="currency_input">$</span>
                                                    <input type="number" step="any" class="numberInputOnly1 form-control  numberInputOnly1 @error('Repairs_Maintenance') is-invalid @enderror " name="Repairs_Maintenance" id="Repairs_Maintenance" placeholder="0.00" value="@if(!empty($fq->Repairs_Maintenance)){{old('Repairs_Maintenance', $fq->Repairs_Maintenance)}}@endif">
                                                ...
                                                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                  <div class="form-group">
                                                    ...
                                                    <span class="currency_input">$</span>
                                                    <input type="number" step="any" class="numberInputOnly1 form-control  numberInputOnly1 @error('Insurance') is-invalid @enderror " name="Insurance" id="Insurance" placeholder="0.00" value="@if(!empty($fq->Insurance)){{old('Insurance', $fq->Insurance)}}@endif">
                                                    @error('Insurance')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                                ...
                                                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                  <div class="form-group">
                                                    ...
                                                    <span class="currency_input">$</span>
                                                    <input type="number" step="any" class="numberInputOnly1 form-control  numberInputOnly1 @error('Current_Taxes') is-invalid @enderror " name="Current_Taxes" id="Current_Taxes" placeholder="0.00" value="@if(!empty($fq->Current_Taxes)){{old('Current_Taxes', $fq->Current_Taxes)}}@endif">
                                                    @error('Current_Taxes')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                                ...
                                                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                  <div class="form-group">
                                                    ...
                                                    <span class="currency_input">$</span>
                                                    <input type="number" step="any" class="numberInputOnly1 form-control  numberInputOnly1 @error('Other_Installment_Payments') is-invalid @enderror " name="Other_Installment_Payments" id="Other_Installment_Payments" placeholder="0.00" value="@if(!empty($fq->Other_Installment_Payments)){{old('Other_Installment_Payments', $fq->Other_Installment_Payments)}}@endif">
                                                ...
                                                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                  <div class="form-group">
                                                    ...
                                                    <span class="currency_input">$</span>
                                                    <input type="number" step="any" class="numberInputOnly1 form-control  numberInputOnly1 @error('Total_Business_Expenses') is-invalid @enderror " name="Total_Business_Expenses" id="Total_Business_Expenses" placeholder="0.00" value="@if(!empty($fq->Total_Business_Expenses)){{old('Total_Business_Expenses', $fq->Total_Business_Expenses)}}@endif">
                                                ...
                                                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                  <div class="form-group">
                                                    ...
                                                    <span class="currency_input">$</span>
                                                    <input type="number" step="any" class="numberInputOnly1 form-control  numberInputOnly1 @error('Net_Business_Income') is-invalid @enderror " name="Net_Business_Income" id="Net_Business_Income" placeholder="0.00" value="@if(!empty($fq->Net_Business_Income)){{old('Net_Business_Income', $fq->Net_Business_Income)}}@endif">
                                              ...
                                              <div class="row">
                                                ...
                                                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
                                                  <div class="form-group">
                                                    <label class="form-head" for="exampletext">Other Installment Payments</label>
                                                    <span class="currency_input">$</span>
                                                    <input type="number" step="any" class="numberInputOnly1 form-control  numberInputOnly1 @error('Other_Installment_Payments') is-invalid @enderror " name="Other_Installment_Payments" id="Other_Installment_Payments" placeholder="0.00" value="@if(!empty($fq->Other_Installment_Payments)){{old('Other_Installment_Payments', $fq->Driver_License)}}@endif">
                                                    @error('Other_Installment_Payments')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                    ...
                                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control @error('Discharge/Dismissal_Date') is-invalid @enderror" name="Discharge/Dismissal_Date" id="Discharge/Dismissal_Date" value="@if(!empty($fq->Discharge_Dismissal_Date)){{old('Discharge/Dismissal_Date#', $fq->Discharge_Dismissal_Date)}}@endif"
...
// $(function () {
//     $(".numberInputOnly1").keydown(function (event) {
