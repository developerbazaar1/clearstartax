                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 mt-3">
                        ...
                        <form action="{{route('to-store')}}" method="POST"  enctype="multipart/form-data">
                            ...
                            <div class="row mt-3">
                                ...
                                @if( $errors->has('spouse_first_name') || $errors->has('spouse_last_name') || $errors->has('spouse_ssn') || $errors->has('spouse_date_of_birth') || $errors->has('spouse_occupaton') || old('Client_Filing_Status') == 'separately' || old('Client_Filing_Status') == 'jointly' )
                                ...
                                <!-- emp show hide -->
                                @if( $errors->has('Do_you_have_your_W2s') || old('Client_Employment_Status') == 'wage')
                                ...
                                @if( $errors->has('Upload_your_W2s') || old('Do_you_have_your_W2s') == 'Yes' )
                                ...
                                @if( $errors->has('We_can_file_back_year_returns_based_on_IRS_wage_and_income') || ( old('Do_you_have_your_W2s') == 'No' &&  old('Client_Employment_Status') == 'wage') )
                                ...
                                @if( $errors->has('You_Will_Need_To_Upload_your_W2s') || (old('We_can_file_back_year_returns_based_on_IRS_wage_and_income') == 'No' &&  old('Client_Employment_Status') == 'wage') )
                                ...
                                @if( $errors->has('Name_Of_Business') ||  $errors->has('Tax_ID')  ||  $errors->has('Business_Activity') ||  $errors->has('Do_you_have_a_profit_and_loss_statement') ||  old('Client_Employment_Status') == 'selfemployed' || old('Client_Employment_Status') == 'businessowner')
                                <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12" id="long-select" style="display: block;">
                                    ...
                                    <div class=" row ext-r">
                                        ...
                                        @if((old('Client_Employment_Status') == 'selfemployed' || old('Client_Employment_Status') == 'businessowner') && old('Do_you_have_a_profit_and_loss_statement') == 'No')
                                        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 mt-2 mb-2 dependency-tab"
                                ...
                                @if( $errors->has('How_many_dependents_do_you_have') || old('Do_you_have_any_dependents_EXCLUDING_yourself_and_your_spouse') == 'have any dependents yes' )
                                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 mt-3 text-left"
                                ...
                                @if( $errors->has('Upload_Form_1099B') || old('Did_you_acquire_or_dispose_of_any_stocks_or_bonds_during_the_yea') == 'Yes' )
                                ...
                                @if( $errors->has('Amount') ||  $errors->has('Number_of_children_cared_for') ||  $errors->has('Services_Performed_in_your_house') ||  $errors->has('Name_address_of_provider') ||old('Did_you_have_any_child_care_expenses_other_than_Child_Support') == 'Yes' )
                                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 mt-2 mb-2 dependency-tab"
                                ...
                                @if( $errors->has('Upload_all_1095_or_proof_of_insurance') || old('Are_you_your_spouse_and_all_dependents_covered_by_health_insuran') == 'Partial' || old('Are_you_your_spouse_and_all_dependents_covered_by_health_insuran') == 'Yes'  )
