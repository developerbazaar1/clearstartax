...
<div class="app-title">
	<div class="user-dashboard-welcome">
      ...
      <!-- <h5 class="mt-10 mb-5px">Step into Your Payment Hub: Centralized Access to Your Financial Transactions!</h5> -->
		<h5 class="mt-10 mb-5px">Payment Hub</h5>
	</div>
				...
				<!-- <form> -->
					...
					<div class="row justify-content-center p-4">
						...
						<div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
							...
							<div class="d-flex justify-content-between">
								<span class="bill-summary-label wnp">
									<div class="form-check">
										<label class="form-check-label">
					...
					<div class="tab-content">
						...
						<div class="tab-pane active" id="home" role="tabpanel" aria-labelledby="home-tab">
								...
								<div class="row justify-content-center p-4">
									...
									<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
										<div class="form-group">
											...
											<input type="text"  data-ref="cardNumber" autocomplete="off" value="" class="form-control card-input__input" name="name_on_card" id="name_on_card" placeholder="Enter Card Holder Name"  required>
									...
									<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
										<div class="form-group">
											...
											<input type="text"  data-ref="" autocomplete="off" class="City_val form-control card-input__input" id="City"  name="City" value="" required>
									...
									<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
										<div class="form-group">
											...
											<input type="text"  data-ref="" autocomplete="off" class="Zipcode_val form-control card-input__input margin-right-5" id="Zip"  name="Zip" value="" required>
							...
							<div class="payment-info text-center">
								<p class="mx-2" style="
    font-size: 0.9rem;
">By clicking "Pay", you agree to Clear Start Tax Relief's Payment <a href="https://clearstarttax.com/paymenttermsandconditions" class="trmandcnd">Terms and Conditions.</a>
								</p>
								<p class="mx-3 mt-1" style="
    font-size: 0.9rem;
...
">
						...
						<a href="mailto:info@clearstarttax.com" class="tel">billing@clearstarttax.com </a>
					</div>
				</div>
							</div>
						</div>
...
$("#expiry_month").keyup(function(){
    var expMonth = $("#expiry_month").val();
      if (expMonth < 1 || expMonth > 13){
        $('.error_card').html('Please enter valid month');
        $('.error_card').addClass('alert alert-danger');
        return false;
      }else{
        $('.error_card').html('');
...
$("#expiry_year").keyup(function(){
    var expYear = $("#expiry_year").val();
      if (expYear < 2023 || expYear > 2060){
        $('.error_card').html('Please enter valid year');
        $('.error_card').addClass('alert alert-danger');
        return false;
      }else{
        $('.error_card').html('');
