                    ...
                    <div class="col-md-12 login-form">
                        <div class="form-head-image text-center mt-3">
                            <span class="back-to-signin">
                                <a href="{{ route('login') }}" class="tab-swich-link text-link-blue" id="signin-link">
                        ...
                        <div class="form-description text-center mt-3">
                            <h6>Reset your password by entering your registered email address.</h6>
                        </div>
                        @if (session('status'))
                        ...
                        @endif
                        <form method="POST" action="{{ route('password.email') }}" class=" login-signup-form" autocomplete="off" >
                        @csrf
                            ...
                            <div class="form-group mb-2">
                                ...
                                <div class="inputWithIcon">
                                    ...
                                    <input id="email" type="email" placeholder="Please enter your email address"  class=" @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required>
                                    @error('email')
