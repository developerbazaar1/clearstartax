                            ...
                            <div class="col-md-12 login-form">
                                ...
                                <form class="login-signup-form" autocomplete="off" method="POST" action="{{ route('auth-register') }}">
                                    ...
                                    <div class="form-group text-center mb-1">
                                        <button type="submit" class="signin-btn">SIGNUP</a>
                                    </div>
                                </form>
                                <!-- :: signup tag with anchor btn -->
                                <div class="1tab-switch-content text-center mt-3">
                                    <p>Already have an account <a href="{{ route('login') }}" class="1tab-swich-link text-link-blue" id="1signin-link"> Sign In Now</a>
                                    </p>
                                </div>
                                <!--:: login info -->
