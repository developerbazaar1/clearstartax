                        ...
                        <div class="row justify-content-center ">
                            <div class="col-md-12 login-form">
                                ...
                                <div class="form-description text-center mt-3">
                                    <h6>Sign Up And Access Your Exclusive Client Portal!</h6>
                                </div>
                                ...
                                <form class="login-signup-form" autocomplete="off" method="POST" action="{{ route('auth-register') }}">
                                    @csrf
                                    <div class="form-group mb-2">
                                        <label class="form-head log-form-label" for="mailer-mail">Case ID</label>
                                        <div class="inputWithIcon">
                                            
                                            <input id="case_id" type="text" class="form-control @error('case_id') is-invalid @enderror" name="case_id" value="{{ old('case_id') }}" placeholder="Please enter your case ID" required>
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        <div class="inputWithIcon">
                                            ...
                                            <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" placeholder="Please enter your email address" required>
                                    ...
                                    <div class="form-group  mb-2 ">
                                        ...
                                        <div class="inputWithIcon">
                                            <input id="password-confirm" type="password" class="form-control" name="password_confirmation" placeholder="Please enter your password" required>
                                            <svg class="i" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                    ...
                                    <div class="form-check mt-2 mb-2">
                                        <input class="form-check-input" type="checkbox" name="termscheck" value="1" id="termscheck" required>
                                        <label class="form-check-label check-label" for="flexCheckDefault">I agree to Terms & Privacy Policy to create an account.</label>
                                    </div>
                                    <!-- :: signinbtn -->
                                    <div class="form-group text-center mb-1">
                                        <button type="submit" class="signin-btn">Sign Up</a>
                                    </div>
                                </form>
                                <!-- :: signup tag with anchor btn -->
                                <div class="1tab-switch-content text-center mt-3">
                                    <p>Already have an account <a href="{{ route('login') }}" class="1tab-swich-link text-link-blue" id="1signin-link"> Sign In</a>
                                    </p>
                                </div>
                                <!--:: login info -->
