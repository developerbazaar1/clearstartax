...
class AuthController extends Controller
{
    ...
    try{
            ...
            // [
            //     'case_id' => 'required|unique:users,case_id',
            //     'email' => 'required|email|unique:users,email',  
            //     'password' => 'required|min:6,'
            // ]);
            
            $validateUser = Validator::make($request->all(), [
                'case_id' => 'required|unique:users,case_id,message', // Add your custom message here
                'email' => 'required|email|unique:users,email',
                'password' => 'required|min:6',
            ], [
                'case_id.unique' => 'There\'s already an existing account associated with this case number.',
            ]);
