...
class ToController extends Controller
{
    ...
    { 
        ...
        if ($action === 'function2') {
                ...
                if ($request->input('Client_Employment_Status') == 'wage' && $request->input('Do_you_have_your_W2s') == 'Yes') {
                    $rules['Upload_your_W2s'] = 'required';
                }

                if ($request->input('Client_Employment_Status') == 'wage' && $request->input('Do_you_have_your_W2s') == 'No') {
                    $rules['We_can_file_back_year_returns_based_on_IRS_wage_and_income'] = 'required';
                }

                if ($request->input('Client_Employment_Status') == 'wage' && $request->input('We_can_file_back_year_returns_based_on_IRS_wage_and_income') == 'No') {
                ...
                if (($request->input('Client_Employment_Status') == 'selfemployed') || ($request->input('Client_Employment_Status') == 'businessowner') && $request->input('Do_you_have_a_profit_and_loss_statement') == 'Yes') {
                    $rules['Upload_Profit_Loss_Statement'] = 'required';
                }

                if (($request->input('Client_Employment_Status') == 'selfemployed') || ($request->input('Client_Employment_Status') == 'businessowner') && $request->input('Do_you_have_a_profit_and_loss_statement') == 'No') {
                ...
                $data = array(
                      ...
                      "Upload_your_W2s" => $request->input('Upload_your_W2s'),
                      ...
                      "You_Will_Need_To_Upload_your_W2s" => $request->input('You_Will_Need_To_Upload_your_W2s'),
                      ...
                      "Upload_Form_1099B" => $request->input('Upload_Form_1099B'),
                    ...
                    for($i = 1; $i <= $dependent_count; $i++) {
                        if($request->file('dependent_bc_and_ssn'.$i)){
                            ...
                            if($image->isValid()){
                                ...
                                $formInput['dependent_bc_and_ssn'] = 'upload/fq/'.$fileName;
                            }
                        ...
                        if($request->file('dependent_upload_sr'.$i)){
                            ...
                            if($image->isValid()){
                                ...
                                $request->$tt->move($image_path, $fileName); 
                                $formInput['dependent_upload_sr'] = 'upload/fq/'.$fileName;
                            }
                ...
                $todataall = To::where('id', $fqid)->first();
    ...
    { 
        ...
        // store fq start
                ...
                return redirect('tos')->with('success',"To Updated Successfully!");
