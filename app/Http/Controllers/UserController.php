...
class UserController extends Controller
{
   public function more_info()
    ...
    public function appointment()
    {
        ...
        return view('appointment', compact('settlement_officer'));
    }
    ...
    { 
        ...
        Mail::send('getintouch_email_template', $email_data, function ($message) use ($email_data) {
                    $message->to('pragyakushwah2017@gmail.com', 'Team')
                    ->subject('Get in touch information')
                    ->from('reply@dbtechserver.online', 'Clear start tax');
                    });

        return redirect()->back()->with('success', 'Thanks for filling out our form!');  
    }
