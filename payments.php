...
<body class="app sidebar-mini">
    ...
    <main class="app-content">
        <div class="app-title">
            <div class="user-dashboard-welcome">
                ...
                <h5 class="mt-12 mb-5px">"Step into Your Payment Hub: Centralized Access to Your Financial Transactions!"</h5>
            </div>
    ...
    <div class="tab-content">
      <div class="tab-pane active" id="home" role="tabpanel" aria-labelledby="home-tab">Home content goes here.</div>
      <div class="tab-pane" id="profile" role="tabpanel" aria-labelledby="profile-tab">Profile content goes here.</div>
    </div>
  </div>
                    </div>
                </div>
