									...
									<div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
											...
											<span class="bill-summary-label">
												<div class="form-check">
													<label class="form-check-label">
														<input type="radio" class="form-check-input" name="optradio"> Past due balance: </label>
												</div>
											</span>
										...
										<div class="d-flex justify-content-between">
											<span class="bill-summary-label">
												<div class="form-check">
													<label class="form-check-label">
														<input type="radio" class="form-check-input" name="optradio"> Remaining balance: </label>
												</div>
											</span>
										...
										<div class="d-flex justify-content-between">
											<span class="bill-summary-label">
												<div class="form-check">
													<label class="form-check-label">
														<input type="radio" class="form-check-input" name="optradio"> Other Amount </label>
												</div>
											</span>
											...
											<div class="row justify-content-center p-4">
												...
												<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
													<div class="form-group">
														...
														<input type="text" class="form-control" id="exampleInputtext" placeholder="Enter card information" required="">
													</div>
												</div>
												<!-- :: input 03 -->
												<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
												...
												<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
													<div class="form-group">
														<label class="form-head" for="exampletext"> CVV <span class="and">?</span> : </label>
														<input type="text" class="form-control" id="exampleInputtext" placeholder="Enter card CVV no." required="">
													</div>
												</div>
												<!-- :: input 05 -->
												<div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
													<div class="form-group">
														...
														<input type="text" class="form-control" id="exampleInputtext" placeholder="Enter email address" required="">
													</div>
												</div>
											...
											<div class="row justify-content-center p-4">
												...
												<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
													<div class="form-group">
														...
														<input type="text" class="form-control" id="exampleInputtext" placeholder="Enter bank name" required="">
													</div>
												</div>
												<!-- :: input 02 -->
												<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
													<div class="form-group">
														...
														<input type="text" class="form-control" id="exampleInputtext" placeholder="Enter account holder name" required="">
													</div>
												</div>
												<!-- :: input 03 -->
												<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
