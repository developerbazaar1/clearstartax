	...
	<body class="app sidebar-mini">
			...
			<ul class="app-menu">
				<li>
					<a class="app-menu__item" href="dashboard.html">
						<svg class="app-menu__icon mx-3" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
							<g fill="none" stroke="white" stroke-width="1.5">
								...
								<path stroke-linecap="round" d="M22 14c0 3.771 0 5.657-1.172 6.828C19.657 22 17.771 22 14 22m-4 0c-3.771 0-5.657 0-6.828-1.172C2 19.657 2 17.771 2 14m8-12C6.229 2 4.343 2 3.172 3.172C2 4.343 2 6.229 2 10m12-8c3.771 0 5.657 0 6.828 1.172C22 4.343 22 6.229 22 10" />
							</g>
						</svg>
					...
					<a class="app-menu__item" href="dashboard.html">
						<svg class="app-menu__icon mx-3" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
							<g fill="none">
								...
								<path fill="white" d="M18 17a1 1 0 1 1-2 0a1 1 0 0 1 2 0Zm0-4a1 1 0 1 1-2 0a1 1 0 0 1 2 0Zm-5 4a1 1 0 1 1-2 0a1 1 0 0 1 2 0Zm0-4a1 1 0 1 1-2 0a1 1 0 0 1 2 0Zm-5 4a1 1 0 1 1-2 0a1 1 0 0 1 2 0Zm0-4a1 1 0 1 1-2 0a1 1 0 0 1 2 0Z" />
							</g>
						</svg>
				...
				<li>
					<a class="app-menu__item" href="dashboard.html">
						<svg class="app-menu__icon mx-3" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
							<g fill="none">
								<path stroke="white" stroke-linecap="round" stroke-width="1.5" d="M10.125 8.875a1.875 1.875 0 1 1 2.828 1.615c-.475.281-.953.708-.953 1.26V13" />
								<circle cx="12" cy="16" r="1" fill="white" />
								<path stroke="white" stroke-linecap="round" stroke-width="1.5" d="M22 12c0 4.714 0 7.071-1.465 8.535C19.072 22 16.714 22 12 22s-7.071 0-8.536-1.465C2 19.072 2 16.714 2 12s0-7.071 1.464-8.536C4.93 2 7.286 2 12 2c4.714 0 7.071 0 8.535 1.464c.974.974 1.3 2.343 1.41 4.536" />
							</g>
						</svg>
		...
		<main class="app-content">
            ...
            <div class="row">
                ...
                Your documents are currently incomplete and require immediate review and completion.
  <a type="button" class="close link-text" data-dismiss="alert" aria-label="Close"> close
    <span aria-hidden="true"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 25 25" fill="none">
<path fill-rule="evenodd" clip-rule="evenodd" d="M21.4233 4.75666C21.5008 4.67918 21.5623 4.5872 21.6042 4.48597C21.6461 4.38473 21.6677 4.27623 21.6677 4.16666C21.6677 4.05709 21.6461 3.94859 21.6042 3.84736C21.5623 3.74612 21.5008 3.65414 21.4233 3.57666C21.3458 3.49918 21.2539 3.43772 21.1526 3.39579C21.0514 3.35386 20.9429 3.33228 20.8333 3.33228C20.7238 3.33228 20.6153 3.35386 20.514 3.39579C20.4128 3.43772 20.3208 3.49918 20.2433 3.57666L12.5 11.3217L4.75666 3.57666C4.67918 3.49918 4.5872 3.43772 4.48597 3.39579C4.38473 3.35386 4.27623 3.33228 4.16666 3.33228C4.05709 3.33228 3.94859 3.35386 3.84736 3.39579C3.74612 3.43772 3.65414 3.49918 3.57666 3.57666C3.49918 3.65414 3.43772 3.74612 3.39579 3.84736C3.35386 3.94859 3.33228 4.05709 3.33228 4.16666C3.33228 4.27623 3.35386 4.38473 3.39579 4.48597C3.43772 4.5872 3.49918 4.67918 3.57666 4.75666L11.3217 12.5L3.57666 20.2433C3.42018 20.3998 3.33228 20.612 3.33228 20.8333C3.33228 21.0546 3.42018 21.2668 3.57666 21.4233C3.73314 21.5798 3.94537 21.6677 4.16666 21.6677C4.38795 21.6677 4.60018 21.5798 4.75666 21.4233L12.5 13.6783L20.2433 21.4233C20.3998 21.5798 20.612 21.6677 20.8333 21.6677C21.0546 21.6677 21.2668 21.5798 21.4233 21.4233C21.5798 21.2668 21.6677 21.0546 21.6677 20.8333C21.6677 20.612 21.5798 20.3998 21.4233 20.2433L13.6783 12.5L21.4233 4.75666Z" fill="#007899"/>
            ...
            <!-- alert end here -->
			<div class="row bg-white case-status-card mb-3 pb-2">
						...
						<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 p-10-20">
							<div class="tile-body case-inner-card-first">
								...
								<div class="case-card-info d-flex mt-4">
									...
									<a href="#" class="info-inner-link mx-4">Click Here</a>
								</div>
							</div>
						</div>
						<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 p-10-20">
							<div class="tile-body case-inner-card-second">
								<div class="case-card-text">
									<h5>What this means: <span class="mx-1">
											<a href="" class="li-text">Details Shown Here</a>
										</span>
