	...
	<body class="app sidebar-mini">
						...
						<div class="f-tab-cnt">
							...
							<div class="table-responsive w-nowrap mt-4">
								...
								<table class="table table-hover">
									...
									<tbody>
										<tr>
											<td>16695371 <img class="w-10px complete-table-status ml-1" src="img/correct-image.png">
											</td>
											<td>Mark</td>
											<td>Otto</td>
											<td>@mdo</td>
							...
							<div class="row">
								<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
									<div class="float-left">
										<a href="#" class="back-to-tab-one">
											<iconify-icon icon="solar:arrow-left-linear" style="color: black;" width="30" height="30"></iconify-icon>
										</a>
									</div>
								</div>
								<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
									<div class="mt-3">
										<h6>Please continue and fill out the form. Answers will be saved in your account. </h6>
									</div>
								</div>
								...
								<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 mt-3">
									...
									<div class="warning-text mt-3 text-left">
										<p>Please fill out the financial questionnaire and upload any documents required. </p>
										<p>You may pause and continue your financial questionnaire anytime by clicking "save progress" at the bottom of the form</p>
										<h6>Contact us if you need help with the form:</h6>
										<p class="mb-2">
											<strong>Phone:</strong>
											<span>
												<a href="#" class="#">Phone: 888-235-0004</a>
											</span>
										</p>
										<p class="mb-2">
											<strong>Email:</strong>
											<span>
												<a href="#" class="#">info@clearstarttax.com</a>
											</span>
										</p>
										<p class="mb-2">
											<strong>Hours:</strong> Monday-Friday 8am-5pm Pacific Standard Time.
										</p>
									</div>
									<!-- :: form start here -->
									<form>
										...
										<div class="row mt-3">
											...
											<div class="col-md-3 col-lg-3 col-sm-12 col-xs-12 text-left">
												<div class="form-group">
													...
													<input type="text" class="form-control" id="exampleInputtext" placeholder="Enter Last name" required>
												</div>
											</div>
											<!-- :: input 02 -->
											<div class="col-md-3 col-lg-3 col-sm-12 col-xs-12 text-left">
												<div class="form-group">
													...
													<input type="text" class="form-control" id="exampleInputtext" placeholder="Enter First name" required>
												</div>
											</div>
											<!-- input 03 -->
											<div class="col-md-3 col-lg-3 col-sm-12 col-xs-12 text-left">
												<div class="form-group">
													...
													<input type="date" class="form-control" id="exampleInputtext" placeholder="Enter first name" required>
												</div>
											</div>
											<!-- :: input 04 -->
											<div class="col-md-3 col-lg-3 col-sm-12 col-xs-12 text-left">
												<div class="form-group">
													...
													<input type="text" class="form-control" id="exampleInputtext" placeholder="Enter your SSN " required>
												</div>
											</div>
											<!-- :: input 05 -->
											<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
												<div class="form-group">
													...
													<input type="text" class="form-control" id="exampleInputtext" placeholder="Enter your street address " required>
												</div>
											</div>
											<!-- :: input 06 -->
											<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
												<div class="form-group">
													...
													<input type="text" class="form-control" id="exampleInputtext" placeholder="Enter your address " required>
												</div>
											</div>
											<!-- :: input 07 -->
											<div class="col-md-3 col-lg-3 col-sm-12 col-xs-12 text-left">
												<div class="form-group">
													...
													<input type="text" class="form-control" id="exampleInputtext" placeholder="Enter your city " required>
												</div>
											</div>
											<!-- :: input 08 -->
											<div class="col-md-3 col-lg-3 col-sm-12 col-xs-12 text-left">
											...
											<div class="col-md-3 col-lg-3 col-sm-12 col-xs-12 text-left">
												<div class="form-group">
													...
													<input type="text" class="form-control" id="exampleInputtext" placeholder="Enter your zip " required>
												</div>
											</div>
											<!-- :: input 10 -->
											<div class="col-md-3 col-lg-3 col-sm-12 col-xs-12 text-left">
												<div class="form-group">
													<label class="form-head" for="exampletext"> County Of Residence : </label>
													<input type="text" class="form-control" id="exampleInputtext" placeholder="Enter your  country " required>
												</div>
											</div>
											<!-- :: input 11 -->
											<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
												<div class="form-group">
													<label class="form-head" for="exampletext"> Rent Or Own (eg. share rent, live with relative, etc. : </label>
													<input type="text" class="form-control" id="exampleInputtext" placeholder="Rent or own" required>
												</div>
											</div>
											<!-- :: input 12 -->
											<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
												<div class="form-group">
													...
													<input type="text" class="form-control" id="exampleInputtext" placeholder="Enter your driving license number" required>
												</div>
											</div>
											<!-- :: input 13 -->
											<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
												<div class="form-group">
													<label class="form-head" for="exampletext"> Primary Phone Number </label>
													<input type="tel" class="form-control" id="exampleInputtext" placeholder="Enter your primary phone number" required>
												</div>
											</div>
											<!-- :: input 14 -->
											<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
												<div class="form-group">
													<label class="form-head" for="exampletext"> Secondry Phone Number </label>
													<input type="tel" class="form-control" id="exampleInputtext" placeholder="Enter your secondary phone number" required>
												</div>
											</div>
											<!-- :: input 15 -->
											<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 text-left">
		...
		<script>
			document.addEventListener("DOMContentLoaded", function() {
				...
				// listener to the switch button
				switchButton.addEventListener("click", function(e) {
					e.preventDefault();
					toggleTabs();
				});
				//  listener to the back link
