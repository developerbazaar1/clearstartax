...
<body>
    <p style="margin-bottom:10px; text-align: center;"><b>Consent, Verification of Information, and Electronic Signature
            Agreement</b></p>
    <p style="text-align: justify; margin-bottom: 10px;">By clicking "Submit," I, the undersigned, acknowledge and
    ...
    <p style="border-color: black; margin: 10px; border-style: solid; border-width: 1px 1px 1px 1px;">Client's Email:
    </p>
    <p style="border-color: black; margin: 10px; border-style: solid; border-width: 0 1px 1px 1px;">Signers IP: </p>
    <p style="border-color: black; margin: 10px; border-style: solid; border-width: 0 1px 1px 1px;">Time Stamp: </p>
    <p style="border-color: black; margin: 10px; border-style: solid; border-width: 0 1px 1px 1px; margin:3px">Signed
        Date: </p>
    <p style="border-color: black; margin: 10px; border-style: solid; border-width: 0 1px 1px 1px;">Client's Name:</p>
    <p style="border-color: black; margin: 30px 10px; border-style: solid; border-width: 0 1px 1px 1px;">Client's
        Signature: <font face="buenossignature400" style="font-size:18px; font-weight:300"></font>
    </p>
</body>
